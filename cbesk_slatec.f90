...
!***END PROLOGUE  CBESK
!
! Change to double precision by M.O
  COMPLEX (kind = 4) :: CY, Z
  REAL (kind = 4) :: AA, ALIM, ALN, ARG, AZ, DIG, ELIM, FN, FNU, FNUL, RL, R1M5, &
...
!   910415  Prologue converted to Version 4.0 format.  (BAB)
!***END PROLOGUE  CUNK1
  COMPLEX (kind = 4) :: CFN, CK, CONE, CRSC, CS, CSCL, CSGN, CSPN, CSR, CSS, &
   CWRK, CY, CZERO, C1, C2, PHI,  RZ, SUM,  S1, S2, Y, Z, &
   ZETA1,  ZETA2,  ZR, PHID, ZETA1D, ZETA2D, SUMD
  REAL (kind = 4 ) ::ALIM, ANG, APHI, ASC, ASCLE, BRY, CPN, C2I, C2M, C2R, ELIM, &
